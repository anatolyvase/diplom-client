...
export function Hero() {
  return (
    <section className="pt-[12rem] pb-[2rem] bg-[var(--bg-color)] w-full" id="home">
      <div className="flex w-full  justify-center gap-4">
        <div className="home__data">
          ...
          <Link href="#collection" className="flex items-center gap-1 hover:gap-2 transition-all duration-300">
