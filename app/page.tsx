...
export default async function Home() {
  ...
  return (
    <div className="relative  flex flex-col font-[family-name:var(--font-geist-sans)]">
      ...
      <div className="sticky bottom-0 right-0 left-0 bg-white/90 py-[1rem] opacity-100 sm:opacity-0 pointer-events-auto sm:pointer-events-none transition-all duration-300 ">
        <ul className="flex gap-6 justify-center">
          <li className="nav__item">
            <a href="#home" className="flex flex-col justify-center items-center text-gray-900 hover:text-gray-600 ">
              <House />
          ...
          <li className="nav__item">
            <a href="#new" className="flex flex-col justify-center items-center text-gray-900 hover:text-gray-600">
              <Radiation />
          ...
          <li className="nav__item">
            <a href="#collection" className="flex flex-col justify-center items-center text-gray-900 hover:text-gray-600">
              <Compass />
          ...
          <li className="nav__Reg">
            <a href="#products" className="flex flex-col justify-center items-center text-gray-900 hover:text-gray-600">
              <Book />
